...
@-webkit-keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}@keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}.chartjs-render-monitor{-webkit-animation:chartjs-render-animation 0.001s;animation:chartjs-render-animation 0.001s;}</style></head>
  ...
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">FOBO</a>
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="manager_list.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
              매니저 리스트
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="call_manage.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bar-chart-2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
              호출관리
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="manager_houselist.php">
        ...
        <ul class="nav flex-column mb-2">
          ...
          <li class="nav-item">
            <a class="nav-link" href="households.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
              1인 가구 리스트
            </a>
          </li>
...
<?php
   ...
   echo "<thead><th>배달번호</th><th>1인가구번호</th><th>배달상품</th></th><th>상태</th></th><th>운송장번호</th><th>택배회사</th><th>시간</th></tr></thead><tbody>";
 while($row = mysqli_fetch_array($ret)) {
    $jb_edit = '
    <form action="delivery_edit.php" method="POST">
      <input type="hidden" name="del_num" value="' . $row[ 'del_num' ] . '">
      <input type="submit" value="수정">
    </form>
  ';
	  echo "<tr><td>", $row['del_num'], 
	  "</td><td>", $row['house_num'], 
	  "</td><td>", $row['del_goods'],
      "</td><td>", $row['state'],
	  "</td><td>", $row['tracking_num'],
      "</td><td>", $row['courier'],
      "</td><td>", $row['time'],
      "</td><td>", $jb_edit,
