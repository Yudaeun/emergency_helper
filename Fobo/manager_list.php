...
<?php
   ...
   echo "<thead><th>매니저번호</th><th>이름</th><th>핸드폰번호</th></th><th>직업</th></th><th>자격증번호</th></th><th>성별</th></th><th>연결가구번호</th></tr></thead><tbody>";
 while($row = mysqli_fetch_array($ret)) {
	  echo "<tr><td>", $row['manager_num'], 
	  "</td><td>", $row['name'], 
	  "</td><td>", $row['phone'],
      "</td><td>", $row['job'],
	  "</td><td>", $row['license_num'],
      "</td><td>", $row['gender'],
      "</td><td>", $row['house_num'],
