...
<?php
   ...
   echo "<thead><th>가구번호</th><th>이름</th><th>생년월일</th></th><th>성별</th></th><th>주소</th><th>번호</th><th>건강상태</th><th>관리자번호</th></tr></thead><tbody>";
 while($row = mysqli_fetch_array($ret)) {
	  echo "<tr><td>", $row['house_num'], 
	  "</td><td>", $row['name'], 
	  "</td><td>", $row['birthday'],
      "</td><td>", $row['gender'],
	  "</td><td>", $row['address'],
      "</td><td>", $row['phone'],
      "</td><td>", $row['health_state'],
      "</td><td>", $row['manager_num'],
