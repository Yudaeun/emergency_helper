      ...
      <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">1인 가구 계약 관리 리스트</h1>
...
<?php
	...
	$sql = "SELECT * FROM manager_houselist";
 
   $ret = mysqli_query($con, $sql);   
   echo "<thead><th>일련번호</th><th>매니저 번호</th><th>1인가구번호</th><th>계약일</th></tr></thead><tbody>";
 while($row = mysqli_fetch_array($ret)) {
	  echo "<tr><td>", $row['listnum'], 
	  "</td><td>", $row['manager_num'], 
	  "</td><td>", $row['house_num'],
      "</td><td>", $row['contact_day'],
